package com.ecommerce.ecs.features.tenant.controller;
...
public class TenantController {
    ...
    public ResponseEntity<TenantResponse> getTenantByName(@PathVariable String name) {
        TenantResponse response = tenantService.findByName(name);
        return ResponseEntity.ok(response);
    }
